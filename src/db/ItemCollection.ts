...
export const itemcollectionModel = mongoose.model('ItemCollection', ItemCollectionSchema);
...
export async function getItemCollectionsById(itemCollectionIds: number[]): Promise<{}[]> {
