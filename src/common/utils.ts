...
import { AffectedStats } from "../items/schema/ItemSchema";
...
export function increaseStats(entity: IStats, stats: IStats, multiplier = 1) {
  ...
  if (entity.attackSpeed && stats.attackSpeed) entity.attackSpeed += multiplier * stats.attackSpeed;
...
export function setStats(entity: IStats, stats: IStats) {
  ...
  if (entity.attackSpeed && stats.attackSpeed) entity.attackSpeed = stats.attackSpeed;
